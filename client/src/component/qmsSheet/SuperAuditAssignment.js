...
const SuperAuditAssignment = () => {
  ...
  const [superAssignAuditDetails, setSuperAssignAuditDetails] = useState([])
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    const postdata2 = async () => {
        ...
        const res = await fetch("/api/get-sheetlist-data-super-assignment", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        if (res.status === 422 || !data) {
          ...
          if (!data) {
            ...
            setIds(data[0]._id)
            setSuperAssignAuditDetails(data)
    ...
    if (!msisdn || !feedback || !callid ) {
      ...
      const postdata1 = async () => {
        const res1 = await fetch("/api/update-sheet-details-list", {
          ...
          body: JSON.stringify({
            feedback,obtainMarks,finalScore,ids
          }),
        });
        ...
        if (res1.status === 422 || !data1) {
          ...
          history.push("/super-audit-view", {state: "Successfully Calibrated!"})
        } else {
          toast.error("Something went wrong");
        }
      };
        ...
        const updateSuperAuditAssignment = async () => {
          const res1 = await fetch("/api/update-super-assignment", {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
            },
                  ...
                  <div className="card card-info mt-3">
                    ...
                    <div className="card-body">
                        ...
                        <div className="col-sm-3">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              name="msisdn"
                              id="msisdn"
                            //   defaultValue={superAssignAuditDetails?superAssignAuditDetails[0].msisdn:null}
                              style={{ fontSize: "12.4px" }}
                              required
                            />
                        ...
                        <div className="col-sm-3">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              ref={callids}
                              type="text"
                            //   defaultValue={superAssignAuditDetails?superAssignAuditDetails[0].callid:null}
                              name="callid"
                              id="callid"
                              style={{ fontSize: "12.4px" }}
                              required
                      ...
                      >
                        {sheetData
                          ? sheetData.map((element) => {
                            ...
                            { superAssignAuditDetails ? superAssignAuditDetails.map((elems)=>{ 
                                   setIds(elems._id)
                              return <>
                                    ...
                                    return (
                                      ...
                                      >
                                        <div className="row ">
                                          ...
                                          { superAssignAuditDetails? superAssignAuditDetails.map((elem)=>{  
                                        ...
                                        return <>
                                          <div className=" form-group col-sm-1">
                                           ...
                                           { superAssignAuditDetails ? superAssignAuditDetails.map((ele)=>{
                                          return <> 
                                         <div className=" form-group col-sm-2">
                                            <label
                                              style={{ fontSize: "11px" }}
                      ...
                      <div className="row">
                        ...
                        {superAssignAuditDetails ? superAssignAuditDetails.map((index)=>{
                          return <>
                          <div
