...
const fieldname = useRef()
  ...
  let addFormFields = () => {
    setFormValues([
      ...formValues,
      { fieldname: "", controltype: "text", isnumeric: "No", mandatory: "No" },
    ]);
  };
  ...
  const handleSubmit = async (event) => {
    ...
    const collectionname = dynCollection;
    any = formValues;
    param = parameters;
    ...
    const postdata = async () => {
      ...
      if (res.status === 422 || !data) {
        ...
        if (!data) {
          ...
          setSheetData(data);
          setDataField(data[0].any);
          cnt.push(Object.keys(data[0].any).length);
           } 
      }
                    ...
                    <div className="card-body">
                      <div className="row">
                        ...
                        <div className=" form-group col-sm-4">
                          <label htmlFor="xyz">Sheet Name:</label>
                          <span style={{ color: "red" }}>*</span>
                          <select
                            name="collectionname"
                        ...
                        <div className="col-sm-4">
                          <div className="form-group">
                            ...
                            <div className="invalid-feedback">
                            Please input a new sheet name.
                          </div>
                          </div>
                        </div>
                      </div>
                      <div
                        style={{ backgroundColor: "#17a2b8", padding: "6px" }}
                        className="button-section row"
                      >
                        <button
                          id="AddMoreHeader"
                          style={{ fontSize: "10px",backgroundColor:'#343a40', color:'white' }}
                          type="button"
                          className="btn"
