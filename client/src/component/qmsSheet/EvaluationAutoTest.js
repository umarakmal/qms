...
const EvaluationAutoTest = () => {
  ...
  const empids = useRef("")
  const extrafield1s = useRef("")
  const extrafield2s = useRef("")
  ...
  const finalHandleSubmit = (e) => {
    ...
    var extrafield1 = extrafield1s.current.value
    var extrafield2 = extrafield2s.current.value
    ...
    if (Object.values(fieldData).length <= 0) {
      ...
      let OH_Name = empDetails.OHName
      let QH_Name = empDetails.QHName
      let TH_Name = empDetails.THName
      let AH_Name = empDetails.AHName
      let Report_to_Name = empDetails.rptToName
      let DOJ = empDetails.DOJ
      ...
      var xcv = empDetails.clientname + "|" + empDetails.Process + "|" + empDetails.sub_process
      ...
      const postdata1 = async () => {
        fetch(audioURLs)
          ...
          .then((blob) => {
            ...
            return fetch(`${url}/api/sheet-list-submit-for-audio`, { method: "POST", body: fd });
          })
          .then((res) => {
            if (res.status === 200) {
      ...
      //Update audit status into allocation Assignment
      const updateAllocationAssignment = async () => {
        const res1 = await fetch(`${url}/api/update-audit-status`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        if (res1.status === 422 || !data1) {
          ...
          navigate("/random/audit-view", { state: "Successfully Audited!" })
        } else {
          toast.error("Something went wrong");
        }
      };
                ...
                <div style={{ fontSize: "12.3px" }} className="col-md-12">
                  <div className="card card-info mt-3">
                    <div className="card-header">
                      <div className="row">
                        <div className="col">
                          <h4 className="card-title mt-2" style={{ fontSize: '.8rem' }}> Evaluation Form-<span>{newSheetName.join('_')}</span></h4>
                        </div>
                        <div className="col">
                          <NavLink
                            style={{
                        ...
                        {sheetData
                          ? sheetData.map((resp) => {
                            ...
                            return resp.any.map((element) => {
                              ...
                              var req_check = element.mandatory === "Yes" ? true : false;
                                ...
                                >
                                  <Accordion>
                                    <AccordionSummary
                                      ...
                                      className="bg-info"
                                    >
                                      <Typography className="text-uppercase">{el.parameter}</Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                      <Typography>
                                        <div className="row ">
                      ...
                      <div className="row">
                        ...
                        >
                          ...
                          <div className=" form-group mt-2 " >
                            ...
                            <audio src={audioURLs} id="audiofunction" className="mt-2" style={{ width: '100%' }} controls />
                            <div
                              id="wavediv"
                              style={{
                                width: "100%",
                          ...
                          <center className="">
                            ...
                            <button
                              ...
                              className="btn btn-info form-group ml-2"
                            >
                              SUBMIT
                            </button>
                          </center>
...
export default EvaluationAutoTest;
