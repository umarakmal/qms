                        ...
                        {sheetData
                          ? sheetData.map((resp) => {
                            return resp.any.map((element) => {
                              var req_check =
                                element.mandatory === "Yes" ? true : false;
                        ...
                        <div className="col-md-8">
                          ...
                          <>
                            ...
                            >
                              <div
                                style={{
                                  fontSize: "12.4px", marginTop: "13px"
                                }}
                                className="form-group col-md-2"
                              >
                                <label
                              ...
                              <div
                                style={{ fontSize: "12.4px", display: "none", marginTop: "-17px" }}
                            ...
                            >
                              ...
                              <div
                                style={{ fontSize: "12px", display: "none", marginTop: "-12px" }}
                                className="form-group col-md-5"
                                id="inputoption1"
                              >
                                <label
