    ...
    if (subFieldIndex !== null) {
      if (element === 'attributess') {
        ...
        if (strAttValsubpara.indexOf("|") === 0) {
          ...
          newFields[fieldIndex].subFields[subFieldIndex][element] = strAttValsubpara1
        } else {
          newFields[fieldIndex].subFields[subFieldIndex][element] = strAttValsubpara
        }
      } else {
                    ...
                    <div className="card-body">
                      <div className="card">
                        <div className="row card-body col-md-12">
                          <div id="process" className=" form-group col-md-4">
                            <label style={{ fontSize: ".7rem" }} htmlFor="xyz">Process</label>
                        ...
                        <div key={index}>
                          ...
                          >
                            <div className=" row ">
                              <div className="row col-md-11">
                                ...
                                <div className=" col-md-3 form-group">
                                  ...
                                  >
                                    ...
                                    <option id={"yesnumeric_" + index} value="Yes">Yes</option>
                                  </select>
                                </div>
                                <div className=" col-md-3  form-group">
                              ...
                              <div style={{ marginTop: '1.7rem' }} className="form-group col-md-1">
                      ...
                      {parameters.map((element, fieldIndex) => (
                        <div key={fieldIndex}>
                          ...
                          <div style={{ fontSize: ".7rem", borderLeft: "2px solid rgb(23, 162, 184)" }}
                              ...
                              <div className="row col-md-12  form-group">
                                <div className="col-md-6 form-group">
                                  ...
                                  <input
                                    ...
                                    required
                                  />
                                  {paraErrors[fieldIndex] && <div className="text-danger">{paraErrors[fieldIndex]}</div>}
                                </div>
                                ...
                                <div className="form-group mt-4 col-md-2">
                                  <button
                                    ...
                                    onClick={() => addFormFieldsSubParameters(fieldIndex)}
                                  >
                                    <i
                                      className="nav-icon fas fa-plus"
                                      style={{ fontSize: ".7rem" }}
                          ...
                          <div style={{ fontSize: ".7rem", borderLeft: "2px solid green" }}
                            className="card card-body " >
                            <div className="row col-md-12">
                              <div className="row col-md-12 ">
                                <div
                                ...
                                >
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => updateField(fieldIndex, null, "subparameter", e.target.value)}
                                    style={{ fontSize: ".75rem" }}
                                    name="subparameter"
                                    onPaste={handlePaste}
                                    ...
                                    required
                                  />
                                  {subParaErrors[fieldIndex] && <div className="text-danger">{subParaErrors[fieldIndex]}</div>}
                                </div>
                                ...
                                <div className=" form-group col-md-2">
                                  ...
                                  <select
                                    name="na"
                                    onChange={(e) => updateField(fieldIndex, null, "na", e.target.value)}
                                    className="form-control form-control-sm"
                                    style={{ fontSize: ".75rem" }}
                                  >
                                    <option value="No">No</option>
                                ...
                                <div className=" form-group col-md-2">
                                  ...
                                  <select
                                    name="fatal"
                                    onChange={(e) => updateField(fieldIndex, null, "fatal", e.target.value)}
                                    className="form-control form-control-sm"
                                    style={{ fontSize: ".75rem" }}
                                    required
                                  >
                              ...
                              <div className="row col-md-12 ">
                                ...
                                >
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => updateField(fieldIndex, null, "maxmarks", e.target.value)}
                                    ...
                                    required
                                  />
                                  {maxErrors[fieldIndex] && <div className="text-danger">{maxErrors[fieldIndex]}</div>}
                                </div>
                                ...
                                >
                                  ...
                                  <input
                                    type="number"
                                    value={element.opt1 || ""}
                                    onChange={(e) => updateField(fieldIndex, null, "opt1", e.target.value)}
                                    onKeyUp={handleOpt1}
                                    onPaste={(e) => {
                                      e.preventDefault();
                                      return false;
                                    ...
                                    required
                                  />
                                  {opt1Errors[fieldIndex] && <div className="text-danger">{opt1Errors[fieldIndex]}</div>}
                                </div>
                                <div
                                  style={{
                                    fontSize: ".7rem",
                                ...
                                >
                                  ...
                                  <input
                                    type="number"
                                    value={element.opt2 || ""}
                                    onChange={(e) => updateField(fieldIndex, null, "opt2", e.target.value)}
                                    onKeyUp={handleOpt2}
                                    ...
                                    required
                                  />
                                  {opt2Errors[fieldIndex] && <div className="text-danger">{opt2Errors[fieldIndex]}</div>}
                                </div>
                                ...
                                >
                                  ...
                                  <input
                                    type="number"
                                    value={element.opt3 || ""}
                                    onChange={(e) => updateField(fieldIndex, null, "opt3", e.target.value)}
                                    onKeyUp={handleOpt3}
                                    onPaste={(e) => {
                                      e.preventDefault();
                                      return false;
                                ...
                                >
                                  ...
                                  <input
                                    type="number"
                                    value={element.opt4 || ""}
                                    onChange={(e) => updateField(fieldIndex, null, "opt4", e.target.value)}
                                    onKeyUp={handleOpt4}
                              ...
                              <div className="row col-md-12">
                                ...
                                >
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => updateField(fieldIndex, null, "legend", e.target.value)}
                                    style={{ fontSize: ".75rem" }}
                                    onKeyDown={(e) => checkSpecialChar(e)}
                                    onPaste={handlePaste}
                                    name="legend"
                              ...
                              <div className="row col-md-12">
                                ...
                                >
                                  ...
                                  <TagsInput
                                    ...
                                    onChange={(tags) => updateField(fieldIndex, null, 'attributes', tags)}
                                    name="attributes"
                                    className="form-control form-control-sm"
                                    placeHolder="Enter Attributes"
                                  />
                                </div>
                                <div style={{ marginTop: '1.8rem' }} className="col-md-1 form-group ">
                                  {fieldIndex ? (
                                    <button
                                      type="button"
                                      style={{ fontSize: "12px" }}
                                ...
                                <div className="row col-md-12">
                                  <div className="row col-md-12">
                                    ...
                                    >
                                      ...
                                      <input
                                        ...
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "subparameterr", e.target.value)
                                        }
                                        onKeyDown={(e) => checkSpecialChar(e)}
                                        onPaste={handlePaste}
                                        maxLength={'180'}
                                    ...
                                    <div className=" form-group col-md-2">
                                      ...
                                      <select
                                        ...
                                        value={subField.nas || ""}
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "nas", e.target.value)
                                        }
                                        className="form-control form-control-sm"
                                        style={{ fontSize: ".75rem" }}
                                      >
                                    ...
                                    <div className=" form-group col-md-2">
                                      ...
                                      <select
                                        ...
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "fatals", e.target.value)
                                        }
                                        className="form-control form-control-sm"
                                        style={{ fontSize: ".75rem" }}
                                      >
                                  ...
                                  <div className="row col-md-12">
                                    ...
                                    >
                                      ...
                                      <input
                                        ...
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "maxmarkss", e.target.value)
                                        }
                                    ...
                                    >
                                      ...
                                      <input
                                        ...
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "opt1s", e.target.value)
                                        }
                                    ...
                                    >
                                      ...
                                      <input
                                        ...
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "opt2s", e.target.value)
                                        }
                                    ...
                                    >
                                      ...
                                      <input
                                        ...
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "opt3s", e.target.value)
                                        }
                                    ...
                                    >
                                      ...
                                      <input
                                        ...
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "opt4s", e.target.value)
                                        }
                                  ...
                                  <div className="row col-md-12">
                                    ...
                                    >
                                      ...
                                      <input
                                        ...
                                        onChange={(e) =>
                                          updateField(fieldIndex, subFieldIndex, "legends", e.target.value)
                                        }
                                        onKeyDown={(e) => checkSpecialChar(e)}
                                        onPaste={handlePaste}
                                        style={{ fontSize: ".75rem" }}
                                  ...
                                  <div className="row col-md-12">
                                    ...
                                    >
                                      ...
                                      <TagsInput
                                        onKeyUp={(e) => checkSpecialCharForAttri(e)}
                                        value={subField.attributess.split("|") || []}
                                        onChange={(tags) => updateField(fieldIndex, subFieldIndex, "attributess", tags)}
                                        name="attributess"
                                        placeHolder="Enter Attributes"
                                      />
                                    </div>
                                    <div style={{ marginTop: '1.8rem' }} className="col-md-1 form-group">
                                      <button
                                        ...
                                        className="btn btn-sm btn-danger remove_btn"
                                        onClick={() =>
                                          removeFormFieldsSubParameters(fieldIndex, subFieldIndex)
                                        }
                                      >
                                        <i
                                          className="nav-icon fas fa-minus "
