                                ...
                                >
                                  <Accordion>
                                    ...
                                    >
                                      <Typography style={{
                                        fontSize: ".77rem",
                                      }}>{i + 1 + ". " + el.parameter}</Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                      <Typography>
                                        {calibrationDetails
                                          ? calibrationDetails.map(
                                            (elems) => {
                                              return (
                                                <>
                                                  <div className="row ">
                                                      ...
                                                      <div className="row col-md-12">
                                                        <div className="form-group col-md-2 ">
                                                          ...
                                                          <input
                                                            ...
                                                            name="maxmarks"
                                                            className={`form-control form-control-sm col-md-8 ${(el.fatal === "Yes") ? "text-red" : ""
                                                              }`}
                                                        ...
                                                        <div className="form-group col-md-2">
                                                          ...
                                                          <select
                                                            ...
                                                            className={`form-control form-control-sm ${(el.fatal === "Yes") ? "text-red" : ""
                                                              }`}
                                                            style={{
                                                              fontSize:
                                                                "12.4px",
                                                                ...
                                                                <div className="row col-md-12">
                                                                  ...
                                                                  >
                                                                    ...
                                                                    <input
                                                                      ...
                                                                      name="maxmarks"
                                                                      className={`form-control form-control-sm col-md-8 ${(subf.fatals === "Yes") ? "text-red" : ""
                                                                        }`}
                                                                      aria-describedby="emailHelp"
                                                                      readOnly
                                                                    />
                                                                  ...
                                                                  <div className=" form-group col-md-2">
                                                                    ...
                                                                    <select
                                                                      ...
                                                                      className={`form-control form-control-sm ${(subf.fatals === "Yes") ? "text-red" : ""
                                                                        }`}
                                                                      style={{
                                                                        fontSize:
                                                                          "12.4px",
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <select
                                        ...
                                        id="option1"
                                        defaultValue={
                                          index ? index.wow_call_option : null
                                        }
                                        className="form-control form-control-sm"
                                        style={{ fontSize: "12.4px" }}
                                      >
                                    ...
                                    {showWow ?
                                      ...
                                      >
                                        ...
                                        <textarea
                                          ...
                                          type="text"
                                          defaultValue={
                                            index ? index.wow_call_remark : null
                                          }
                                          style={{
                                            fontSize: "12.4px",
                                            marginTop: "8px",
                          ...
                          {/* <div className="form-group row">
                            ...
                            >
                              ...
                              <textarea
                                ...
                                style={{ fontSize: "12.4px" }}
                                defaultValue={
                                  getAuditorRemark ? getAuditorRemark : null
                                }
                                name="feedback"
                                id="feedback"
                                className="form-control form-control-sm"
