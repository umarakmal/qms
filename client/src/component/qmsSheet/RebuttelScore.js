...
postdata();
    ...
    const postdata3 = async () => {
      const res = await fetch("/api/get-rebuttel-score-data", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
   ...
   var  wow_call_option=(wow_call_options.current.value);
    ...
    if (!msisdn || !feedback || !callid ) {
      ...
      const postdata1 = async () => {
        const res1 = await fetch("/api/update-sheet-details-list", {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
          },
          body: JSON.stringify({
           feedback,ids,obtainMarks,finalScore,callid,msisdn,maximumMarks,fatalCount,bonus_call_remark,option_bonus_call,marking_bonus_call,
           ztp_remark,ztp_option,wow_call_remark,wow_call_option,remark,subParaRemarks
          }),
        });
        ...
        if (res1.status === 422 || !data1) {
          ...
          history.push("/rebuttal-view", {state: "Successfull!"})
        } else {
          toast.error("Something went wrong");
        }
      };
      ...
      const qh_remark = feedback
      const qa_remark = ""
      const pre_score = oldScore
      const new_score = finalScore
        //create rebuttal status
        const CreateRebuttalStatus = async () => {
          const res1 = await fetch("/api/create-rebuttal-status", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
            body: JSON.stringify({
              sheetid,auditeeid,auditorid,new_score,pre_score,qh_remark, qa_remark
            }),
          });
                ...
                <div style={{ fontSize: "12.3px" }} className="col-md-12">
                  <div className="card card-info mt-3">
                    <div className="card-header">
                      <div className="row">
                      <div className="col">
                      <h4 className="card-title mt-2" style={{fontSize:'14px'}}> Evaluation Form-<span>{rebuttalScoreData? rebuttalScoreData.sheet_name:null}</span></h4>
                      </div>
                      <div className="col">
                      <NavLink
                        style={{
                        ...
                        <div className="col-sm-3">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              type="text"
                              name="calltype"
                              defaultValue={rebuttalScoreData?rebuttalScoreData.calltypes:null}
                              id="calltype"
                              style={{ fontSize: "12.4px" }}
                            />
                        ...
                        >
                          ...
                          >
                            ...
                            <textarea
                              type="text"
                              ref={feedbacks}
                              defaultValue={rebuttalScoreData? rebuttalScoreData.feedback:null}
                              style={{ fontSize: "12.4px" }}
                              name="feedback"
                              id="feedback"
                              className="form-control form-control-sm"
                          ...
                          >
                            ...
                            <input
                              type="text"
                              ref={obtainedmarks}
                              defaultValue={rebuttalScoreData? rebuttalScoreData.obtainedMarks:null}
                          ...
                          >
                            ...
                            <input
                              type="text"
                              ref={finalscore}
                              defaultValue={rebuttalScoreData? rebuttalScoreData.finalScore:null}
                              value={percnt ? percnt + "%" : ""}
                              style={{ fontSize: "12.4px", marginTop: "8px" }}
                              name="finalscore"
                              className="form-control form-control-sm"
