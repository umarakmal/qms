...
const {
  ...
  updateCalibrationAssignment, getmanualempid, manualdata, getCalibratedData, getDataFromResponceForGraph,
...
router.post("/get-data-from-responce-for-graph", getDataFromResponceForGraph)
